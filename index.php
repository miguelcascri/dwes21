...
<body>
    <h1>MANUEL SALVADOR MUÑOZ COBOS</h1>
    <button class="accordion">TEMA 1</button>
    <div class="panel">
    ...
    <div class="panel">
        ...
        <p>Entrecomillado simple y doble</p>
        <a href="tema 2/ejercicio3.php">EJERCICIO 3</a>
        <p>Conversión tipos de datos</p>
        <a href="tema 2/ejercicio4.php">EJERCICIO 4</a>
    ...
    <button class="accordion">TEMA 8</button>
    <div class="panel">
        <a href="world/Practica Tema 8/index.php">EJERCICIO 1</a>
        <p>Ejercicio World AJAX (XML y JQuery)</p>
    </div>

    <button class="accordion">TEMA 9</button>
    <div class="panel">
        <a href="world/Practica Tema 9/index.php">EJERCICIO 1</a>
